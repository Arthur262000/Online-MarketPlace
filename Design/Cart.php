                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                          <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="CategoriesDropdown">
                                <li><a class="dropdown-item" href="Console.html" id="GamingConsoleDropdown" role="button" data-toggle="modal" aria-expanded="false">Gaming Console</a></li>
                                    <ul>
                                ...
                                <li><a class="dropdown-item" href="Video-game.html" class="dropdown-toggle" id="VideoGamesDropdown" role="button" data-toggle="modal" aria-expanded="false">Video Games</a></li>
                                    <ul>
